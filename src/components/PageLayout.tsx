      ...
      >
        ...
        <div className="grow text-sm leading-normal text-[#abc4ffb3] scrollbar-width-thin overflow-auto h-96 mobile:h-12 rounded p-4 my-6 mobile:my-4 bg-[#141041]">
          <p className="mb-3">
            ...
            bloXroute Solana Trader API, a high-performance tool to interact with Solana applications (the "bloXroute
            Solana Trader API"). This Interface and the bloXroute Solana Trader API are made available by the bloXroute
            Labs, however all transactions conducted on the protocol are run by related permissionless smart contracts.
            As the Interface is open-sourced and the bloXroute Solana Trader API is accessible by any user, entity or
            third party,and mobile user-interfaces that allow for interaction with the bloXroute Solana Trader API.
          </p>
          <p className="mb-3">
            THIS INTERFACE AND THE BLOXROUTE SOLANA TRADER API ARE PROVIDED "AS IS", AT YOUR OWN RISK, AND WITHOUT
            WARRANTIES OF ANY KIND. The bloXroute Labs does not provide, own, or control the Solana applications
            interacted with or any transactions conducted on the blockchain or via related smart contracts. By using or
            accessing this Interface or the bloXroute Solana Trader API and related smart contracts, you agree that no
            developer or entity involved in creating, deploying or maintaining this Interface or the bloXroute Solana
            Trader API will be liable for any claims or damages whatsoever associated with your use, inability to use,
            or your interaction with other users of, this Interface or the bloXroute Solana Trader API, including any
          ...
          <p className="mb-3">
            The bloXroute Solana Trader API is not available to residents of Belarus, the Central African Republic, The
            Democratic Republic of Congo, the Democratic People's Republic of Korea, the Crimea, Donetsk People's
            Republic, and Luhansk People's Republic regions of Ukraine, Cuba, Iran, Libya, Somalia, Sudan, South Sudan,
            Syria, the USA, Yemen, Zimbabwe and any other jurisdiction in which accessing or using the bloXroute Solana
            Trader API is prohibited (the "Prohibited Jurisdictions").
          </p>
          <p className="mb-3">
            By using or accessing this Interface, the bloXroute Solana Trader API, or related smart contracts, you
            represent that you are not located in, incorporated or established in, or a citizen or resident of the
            Prohibited Jurisdictions. You also represent that you are not subject to sanctions or otherwise designated
            on any list of prohibited or restricted parties or excluded or denied persons, including but not limited to
            the lists maintained by the United States' Department of Treasury's Office of Foreign Assets Control, the
            United Nations Security Council, the European Union or its Member States, or any other government authority.
          </p>
        </div>
